...
#always 15 more notes than necessary -- might be adding an extra set of notes, and overwriting some of the older notes which is why some are incorrect chords.
#always 15 more notes than necessary -- might be adding an extra set of notes, and overwriting some of the older notes which is why some are incorrect chords.
#always 15 more notes than necessary -- might be adding an extra set of notes, and overwriting some of the older notes which is why some are incorrect chords.
#always 15 more notes than necessary -- might be adding an extra set of notes, and overwriting some of the older notes which is why some are incorrect chords.
...
sprintnotes = legible(s.notes)
aprintnotes = legible(a.notes)
tprintnotes = legible(t.notes)
bprintnotes = legible(b.notes)
...
with open("daang.mid", "wb") as output_file:
